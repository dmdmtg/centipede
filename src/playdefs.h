...
#define	MUSHVALUE	1	/* Points for shooting entire mushroom.	*/
...
#define	WORMVALUE	10	/* Points for shooting a non-head seg.	*/
#define	HEADVALUE	100	/* Points for shooting a head	*/
